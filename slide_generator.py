...
def scrape_and_extract_text(url):
    try:
        ...
        print(text[:1000])
        print("===================================\n")
        return text[:8000]  # max ~3000 characters
...
def summarize_content(text, topic):
    prompt = f"You are given the following text which is information gathered from internet. Use this and your own knowledge and create 10-15 bullet points for a presentation on '{topic}':\n\n{text}"
...
def create_ppt_from_text(slide_text, filename="output.pptx"):
    ...
    for idx, slide in enumerate(slides):
        ...
        slide_obj.background.fill.fore_color.rgb = RGBColor(248, 250, 252)
